...
def run_uniform_search(current_puzzle, goal_state_1, goal_state_2):
    ...
    return closed_list, foundGoalState
...
def output_solution_list(goal_puzzle, puzzle_num):
    with open(f"../outputs/{puzzle_num}_ucs_solution.txt", "w") as output_file:
        ...
        output_file.write("Total cost: " + str(goal_puzzle.g_cost))
...
def run():
    for i in range(3):
        ...
        search_list, found = run_uniform_search(initial_puzzle, goal_state_1, goal_state_2)
